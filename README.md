## decuscpp-c89
ANSI C port of the DECUS C preprocessor

While the source code of this port complies with the ANSI C standard, its behavior does not.

The original pre-standard version was written by Martin Minow.

Changes:
 * remove code only used on old DEC systems
 * minor refactor
 * comment cleanup
 * Makefile
 * Man page
